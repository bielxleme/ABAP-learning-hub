...
export const INITIAL_BADGES: Badge[] = [
  ...
  {
    id: 'badge_select_25',
    title: 'Mestre em Consultas SQL',
    description: 'Acertou 25 exercícios de SELECT e Open SQL nas tabelas do sistema.',
    icon: 'Database',
    category: 'quiz',
    unlockedTitle: 'Mestre em Queries SAP Open SQL',
  },
  {
    id: 'badge_select_50',
    title: 'Arquiteta de Dados',
    description: 'Realizou 50 consultas de banco de dados com maestria e precisão.',
    icon: 'Layers',
    category: 'quiz',
    unlockedTitle: 'Arquiteta de Dados & Persistência SAP',
  },
  {
    id: 'badge_itab_wizard',
    title: 'Feiticeira das ITABs',
    description: 'Concluiu 15 desafios de manipulação de tabelas internas (APPEND, READ, LOOP, SORT).',
    icon: 'Table',
    category: 'quiz',
    unlockedTitle: 'Especialista em Tabelas Internas & Field-Symbols',
  },
  {
    id: 'badge_syntax_doctor',
    title: 'Auditora de Sintaxe',
    description: 'Executou 5 programas consecutivos no Editor ABAP com código 100% livre de erros.',
    icon: 'CheckCircle2',
    category: 'editor',
    unlockedTitle: 'Auditora de Código & Sintaxe Limpa',
  },
  {
    id: 'badge_zero_dump',
    title: 'Zero Dumps ST22',
    description: 'Completou desafios avançados de exceções e validação sem gerar DUMP no sistema.',
    icon: 'ShieldCheck',
    category: 'quiz',
    unlockedTitle: 'Especialista em Tratamento de Erros e Exceções',
  },
  {
    id: 'badge_recovery_hero',
    title: 'Mente Resiliente',
    description: 'Analisou seus pontos fracos e treinou exercícios de recuperação após cometer erros.',
    icon: 'TrendingUp',
    category: 'quiz',
    unlockedTitle: 'Engenheira de Alta Performance & Evolução Contínua',
  },
  {
    id: 'badge_account_linked',
    title: 'Consultora Verificada',
    description: 'Vinculou sua conta de e-mail ou Google ao perfil de desenvolvimento SAP.',
    icon: 'CheckCircle2',
    category: 'streak',
    unlockedTitle: 'Consultora Verificada SAP Cloud',
  },
  {
    id: 'badge_focus_guru',
    title: 'Foco Imersivo',
    description: 'Concluiu 5 exercícios de programação no Modo Foco sem distrações.',
    icon: 'Maximize2',
    category: 'quiz',
    unlockedTitle: 'Desenvolvedora Foco Total NetWeaver',
  },
  {
    id: 'badge_editor_prodigy',
    title: 'Prodígio do SE38',
    description: 'Escreveu e executou mais de 10 programas autorais no Editor ABAP.',
    icon: 'Code2',
    category: 'editor',
    unlockedTitle: 'Desenvolvedora Sênior NetWeaver (SE38)',
  },
  {
    id: 'badge_join_master',
    title: 'Mestra de Joins & Agregações',
    description: 'Resolveu consultas relacionais com INNER JOIN, SUM e COUNT em tabelas interligadas.',
    icon: 'GitFork',
    category: 'quiz',
    unlockedTitle: 'Especialista em Modelagem Relacional & Joins',
  },
  {
    id: 'badge_simulado_n3',
    title: 'Certificação Nível 3',
    description: 'Aprovada no Simulado Geral do Nível 3 de Tabelas Internas, Modularização e BAPIs.',
    icon: 'Award',
    category: 'simulado',
    unlockedTitle: 'Consultora Pleno em Tabelas Internas & BAPIs',
  },
  {
    id: 'badge_simulado_n4',
    title: 'Certificação Nível 4',
    description: 'Aprovada no Simulado Geral do Nível 4 de ABAP Orientado a Objetos e Design Patterns.',
    icon: 'Award',
    category: 'simulado',
    unlockedTitle: 'Arquiteta em ABAP Orientado a Objetos',
  },
  {
    id: 'badge_simulado_n5',
    title: 'Certificação Nível 5',
    description: 'Aprovada no Simulado Geral do Nível 5 de SAP S/4HANA, CDS Views e ABAP RAP.',
    icon: 'Award',
    category: 'simulado',
    unlockedTitle: 'Especialista SAP S/4HANA & ABAP RAP',
  },
  {
    id: 'badge_simulado_n6',
    title: 'Certificação Nível 6',
    description: 'Aprovada no Simulado Geral do Nível 6 de Formulários, Spool e Internacionalização SE63.',
    icon: 'Award',
    category: 'simulado',
    unlockedTitle: 'Especialista em Formulários & Internacionalização SAP',
  },
  {
    id: 'badge_simulado_n7',
    title: 'Certificação Nível 7',
    description: 'Aprovada no Simulado Geral do Nível 7 de ABAP OO Avançado, Interfaces e Design Patterns.',
    icon: 'Award',
    category: 'simulado',
    unlockedTitle: 'Grã-Mestra em ABAP OO & Design Patterns',
  },
  {
    id: 'badge_rpg_hero',
    title: 'Heroína de RPG NetWeaver',
    description: 'Desferiu o golpe de misericórdia e derrotou seu primeiro chefão de Simulado em combate RPG.',
    icon: 'Shield',
    category: 'simulado',
    unlockedTitle: 'Guerreira Épica de RPG SAP',
  },
  {
    id: 'badge_boss_slayer',
    title: 'Carrasco dos Short Dumps',
    description: 'Triunfou contra 3 ou mais chefões de nível nos simulados oficiais.',
    icon: 'Zap',
    category: 'simulado',
    unlockedTitle: 'Destruidora Suprema de DUMPs ST22',
  },
  {
    id: 'badge_forms_architect',
    title: 'Arquiteta de Impressão',
    description: 'Dominou a teoria de Smart Forms, Adobe Forms (PDF) e ordens de spool SP01.',
    icon: 'Printer',
    category: 'quiz',
    unlockedTitle: 'Mestra em Documentos & Formulários SAP',
  },
  {
    id: 'badge_oo_poly',
    title: 'Polimorfismo & Interfaces',
    description: 'Acertou todos os desafios sobre design patterns, interfaces e herança em classes ABAP.',
    icon: 'Layers',
    category: 'quiz',
    unlockedTitle: 'Especialista em Polimorfismo & Clean OO',
  },
  {
    id: 'badge_speed_coder',
    title: 'Relâmpago da SE38',
    description: 'Resolveu exercícios de programação em tempo veloz com raciocínio ágil.',
    icon: 'Flame',
    category: 'quiz',
    unlockedTitle: 'Desenvolvedora Relâmpago NetWeaver',
  },
  {
    id: 'badge_persistence_king',
    title: 'Resiliência Noturna',
    description: 'Revisou erros e recuperou conceitos complexos demonstrando persistência exemplar.',
    icon: 'TrendingUp',
    category: 'quiz',
    unlockedTitle: 'Mente Invicta & Resiliente SAP',
  },
];
